    ...
    <div className="min-h-screen bg-bonggy-bg flex items-center justify-center px-4">
      <div className="w-full max-w-[440px]">
        ...
        <div className="flex items-center justify-center gap-2.5 mb-10">
          <div className="w-10 h-10 rounded-xl bg-bonggy-accent flex items-center justify-center">
        ...
        <div className="flex items-center gap-2 mb-6">
          <div className={`flex-1 h-1 rounded-full ${step >= 1 ? "bg-bonggy-accent" : "bg-bonggy-border"}`} />
          <div className={`flex-1 h-1 rounded-full ${step >= 2 ? "bg-bonggy-accent" : "bg-bonggy-border"}`} />
        </div>
          ...
          {step === 1 ? (
            <>
              ...
              <form onSubmit={(e) => { e.preventDefault(); setStep(2); }} className="space-y-4">
                <div>
                  <label className="text-[12px] text-bonggy-text-secondary mb-1.5 block">Work Email</label>
                  <input
                    type="email"
                    value={email}
                ...
                <button
                  type="submit"
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg bg-bonggy-text-primary text-bonggy-surface text-[14px] font-medium hover:opacity-85 transition-opacity mt-2"
                >
              ...
              <div className="grid grid-cols-2 gap-3">
                <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-bonggy-border bg-bonggy-bg text-[13px] text-bonggy-text-secondary hover:border-bonggy-border-hover transition-colors">
                  <svg width="16" height="16" viewBox="0 0 16 16">
                    <path fill="#4285F4" d="M14.9 8.2c0-.5 0-1-.2-1.4H8v2.7h3.9c-.2 1-1 2.3-2.8 2.3-1.7 0-3-1.1-3.5-2.6H3.3v1.7C4.3 13 6 14.3 8 14.3c2.3 0 4.2-1.5 4.9-3.5v-2.6z"/>
                  </svg>
                  Google
                </button>
                <button className="flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-bonggy-border bg-bonggy-bg text-[13px] text-bonggy-text-secondary hover:border-bonggy-border-hover transition-colors">
            ...
            <>
              <div className="text-center mb-6">
                <div className="w-12 h-12 rounded-full bg-bonggy-success/10 flex items-center justify-center mx-auto mb-3">
                  <Check size={24} className="text-bonggy-success" />
                </div>
                <h1 className="text-[22px] font-semibold text-bonggy-text-primary mb-1">
                  Account created
                </h1>
                <p className="text-[14px] text-bonggy-text-secondary">
              ...
              <div className="space-y-3">
                ...
                <Link
                  to="/app"
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg border border-bonggy-border text-[14px] text-bonggy-text-secondary hover:border-bonggy-border-hover transition-colors"
                >
                  Skip for now
                </Link>
              </div>
        ...
        <p className="text-center text-[13px] text-bonggy-text-secondary mt-6">
          ...
          <Link to="/login" className="text-bonggy-accent hover:underline font-medium">
            Sign in
          </Link>
        </p>
      </div>
