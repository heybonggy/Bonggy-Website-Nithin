...
// ─── UI Helpers ───
function Logo() {
  return <BonggyMark size={40} className="shrink-0" />;
}
  ...
  return (
    <div className="fixed top-5 left-5 right-5 z-50 flex items-center justify-between bg-bonggy-surface/80 backdrop-blur-md border border-bonggy-border rounded-full px-4 py-2 shadow-sm">
      ...
      <div className="hidden md:flex items-center gap-1">
        <Link href="/" className="text-[13px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-1.5 rounded-md hover:bg-bonggy-bg">Home</Link>
        <Link href="/#how-it-works" className="text-[13px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-1.5 rounded-md hover:bg-bonggy-bg">How it works</Link>
        <Link href="/who-its-for" className="text-[13px] text-bonggy-text-primary font-medium transition-colors px-3 py-1.5 rounded-md bg-bonggy-bg">Who it's for</Link>
        <Link href="/#cta" className="text-[13px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-1.5 rounded-md hover:bg-bonggy-bg">About Us</Link>
        <button
      ...
      <Sheet open={mobileOpen} onOpenChange={setMobileOpen}>
        <SheetContent side="right" className="w-[280px] bg-bonggy-surface border-bonggy-border p-0">
          <div className="flex flex-col gap-1 mt-6 px-4">
            ...
            <Link href="/" onClick={() => setMobileOpen(false)} className="text-[14px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-2.5 rounded-lg hover:bg-bonggy-bg">Home</Link>
            <Link href="/#how-it-works" onClick={() => setMobileOpen(false)} className="text-[14px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-2.5 rounded-lg hover:bg-bonggy-bg">How it works</Link>
            <Link href="/who-its-for" onClick={() => setMobileOpen(false)} className="text-[14px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-2.5 rounded-lg hover:bg-bonggy-bg">Who it's for</Link>
            <Link href="/#cta" onClick={() => setMobileOpen(false)} className="text-[14px] text-bonggy-text-secondary hover:text-bonggy-text-primary transition-colors px-3 py-2.5 rounded-lg hover:bg-bonggy-bg">About Us</Link>
            <button
  ...
  return (
    <div className="min-h-screen bg-bonggy-bg text-bonggy-text-primary font-sans antialiased transition-colors duration-300">
      ...
      <section className="pt-32 md:pt-40 pb-16 px-5 md:px-10 max-w-[800px] mx-auto">
        <Link href="/" className="inline-flex items-center gap-1.5 text-[13px] text-bonggy-text-tertiary hover:text-bonggy-text-primary transition-colors mb-8">
      ...
      <section className="py-20 md:py-28 px-5 md:px-10 bg-bonggy-surface border-t border-bonggy-border">
        <div className="max-w-[640px] mx-auto text-center">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-base font-normal bg-bonggy-accent text-bonggy-bg px-8 py-4 rounded-md hover:bg-bonggy-accent-hover transition-colors"
          >
